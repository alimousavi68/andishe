...
<!-- multi items -->
<div class="col-24 col-xl-8 col-lg-8 col-md-8 col-sm-24 multi-items d-flex px-0 gap-1">
  <div class="row">
    <?php
    ...
    if ($category_posts2->have_posts()): ?>
      <div
        class="col-24 col-lg-24 col-md-24 col-sm-24 d-flex flex-column gap-3 px-2 ps-3 border-start i8-border-sm-none hero-small-column">
          ...
          <div class="secondray-item d-flex flex-column gap-2">
            ...
            <div class="single-item-data d-flex flex-column gap-0 justify-content-between">
              <div class="title-box">
                ...
                <h1 class="post-title display-4 fw-5 l1"><a href="<?php echo get_the_permalink(); ?>" class="i8-blink">
    ...
    ?>
      ...
      if ($category_posts->have_posts()) {
        while ($category_posts->have_posts()) {
          $category_posts->the_post();
          ?>
          <div class="<?php echo $col; ?>  mini-article d-flex   <?php echo ($category_posts->current_post + 1 == $category_posts->post_count) ? '' : 'border-bottom'; ?> pb-2 mb-2 px-0 ">
            <div>
