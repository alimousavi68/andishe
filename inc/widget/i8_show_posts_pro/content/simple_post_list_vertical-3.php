    ...
    while ($category_posts->have_posts()) {
      ...
      <div
        ...
        <a href="<?php the_permalink(); ?>" class="image_frame h-auto">
          <?php echo i8_the_thumbnail('i8-lg-290-163', 'w-100  object-fit-cover overflow-hidden hover i8-img-fit ', $dimenition = array('width' => $thumb_width, 'height' => $thumb_height) , true, '', false, true); ?>
        </a>
        <div class="p-1">
