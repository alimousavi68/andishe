...
function i8_mobile_menu($location, $custom_class = ' ', $icon_size = array('32', '32'))
{
    ...
    echo '<nav class="i8-h-menu ' . $custom_class . ' ">
            ...
            <?xml version="1.0" encoding="UTF-8"?><svg width="'.$icon_size[0].'px" height="'.$icon_size[1].'px" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="var(--i8-light-secondary)"><path d="M8 6h12M4 6.01l.01-.011M4 12.01l.01-.011M4 18.01l.01-.011M8 12h12M8 18h12" stroke="var(--i8-light-secondary )" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>
            </label>
             <div class="m-menu">
        ...
        <div class="d-none d-xl-flex d-lg-flex d-md-flex justify-content-center gap-2 social-links ">
            <?php if ($twitter): ?>
                <a class="p-0 p-lg-0 p-sm-1 dark-btn" target="_blank" href="<?php echo $twitter; ?>" alt="twitter share button"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="<?php echo $width; ?>" height="<?php echo $height; ?>"
                        fill="var(--i8-light-secondary)" class="bi bi-twitter mx-1"
            ...
            <?php if ($facebook): ?>
                <a class="p-0 p-lg-0 p-sm-1 dark-btn" target="_blank" href="<?php echo $facebook; ?>"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="<?php echo $width; ?>" height="<?php echo $height; ?>"
                        fill="var(--i8-light-secondary)" class="bi bi-facebook mx-1"
                        viewBox="0 0 <?php echo $width; ?> <?php echo $height; ?>">
                        <path
            ...
            <?php if ($telegram): ?>
                <a class="p-0 p-lg-0 p-sm-1 dark-btn" href="<?php echo $telegram; ?>" alt="telegram share button"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="<?php echo $width; ?>" height="<?php echo $height; ?>"
                        fill="var(--i8-light-secondary)" class="bi bi-telegram mx-1"
                        viewBox="0 0 <?php echo $width; ?> <?php echo $height; ?>">
                        <path
            ...
            <?php if ($whatsapp): ?>
                <a class="p-0 p-lg-0 p-sm-1 dark-btn" target="_blank" href="<?php echo $whatsapp; ?>"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="<?php echo $width; ?>" height="<?php echo $height; ?>"
                        fill="var(--i8-light-secondary)" class="bi bi-whatsapp mx-1"
                        viewBox="0 0 <?php echo $width; ?> <?php echo $height; ?>">
                        <path
            ...
            <?php if ($instagram): ?>
                <a class="p-0 p-lg-0 p-sm-1 dark-btn" target="_blank" href="<?php echo $instagram; ?>"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="<?php echo $width; ?>" height="<?php echo $height; ?>"
                        fill="var(--i8-light-secondary)" class="bi bi-instagram mx-1"
                        viewBox="0 0 <?php echo $width; ?> <?php echo $height; ?>">
                        <path
            ...
            <?php if ($youtube): ?>
                <a class="p-0 p-lg-0 p-sm-1 dark-btn" target="_blank" href="<?php echo $youtube; ?>" alt="youtube share button"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="<?php echo $width; ?>" height="<?php echo $height; ?>"
                        fill="var(--i8-light-secondary)" class="bi bi-youtube mx-1"
                        viewBox="0 0 <?php echo $width; ?> <?php echo $height; ?>">
                        <path
