...
<div class="row row-gap-4 border-end border-start no-border-on-mobile p-0 p-xl-3 px-lg-3 p-md-3 top-section">
    <!--  top-right-sidebar -->
    <div class="top_section_right col-24 col-xl-18 col-lg-18 col-md-24 main-slider-2 d-flex px-0 gap-0">
    ...
    <!--  top-left-sidebar -->
    <div class="top_section_right col-24 col-lg-6 col-md-24 px-lg-3 ">
        <?php
